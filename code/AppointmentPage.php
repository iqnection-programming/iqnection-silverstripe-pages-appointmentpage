...
class AppointmentPage extends FormPage
{
	...
	public function getCMSFields()
	{
		...
		$fields->addFieldToTab('Root.AppointmentSettings', GridField::create(
		...
		$fields->addFieldToTab("Root.AppointmentSettings", new TextField("AutoResponderFromEmail", "Auto-responder From Email")); 
		$fields->addFieldToTab("Root.AppointmentSettings", new TextField("AutoResponderSubject", "Auto-responder Subject"));
		$fields->addFieldToTab("Root.AppointmentSettings", new CheckboxField("AutoResponderIncludeSubmission", "Include Submitted Data in Email"));  
